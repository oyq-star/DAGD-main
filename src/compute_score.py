        ...
        for subdata_name in os.listdir(f"window_result/{save_file}/50"):
            ...
            for pkl_path in os.listdir(base_path):
                if ".pk" in pkl_path:
                    ...
                    #     open(f"datasets/data_pkl/amazon_windows_length10_checkpoint_tst52_1.pkl", "rb")
                    # )
                    # test_file_2 = pickle.load(
                    #     open(f"datasets/data_pkl/amazon_windows_length10_checkpoint_tst52_2.pkl", "rb")
                    # )
                    test_file_1 = pickle.load(
                        open(f"datasets/data_pkl/amazon_windows_length5_checkpoint_tst52_1_origin_0.pkl", "rb")
                    )
                    test_file_2 = pickle.load(
                        open(f"datasets/data_pkl/amazon_windows_length5_checkpoint_tst52_2_origin_0.pkl", "rb")
                    )
                    label = test_file_1.label
                    ground_truth = test_file_1.data

                    # labels = pickle.load(
                    #     open(f"datasets/data_pkl/{subset_name}_test_label.pkl", "rb")
                    # )
                    ...
                    residual, labels = compute_residual(pkl_file, labels=label, ground_truth=ground_truth,
