...
#amazon 0.06
def compute_one_strategy(data_id,strategy_name,ensemble_strategy_list,csv_writer,last_step_threshold=0.18):
    ...
    # for pkl_path in pkl_path_list:
    ##改改改
    pkl_path='window_result/save0/50/datasets_dbcargo_origin_0_45_unconditional:True_split:1_diffusion_step:50/0-generated_outputs_nsample10_stop_number_-1.pk'
...
if __name__ =="__main__":
    ...
    parser.add_argument("--dataset_name", type=str, default="dbcargo")
